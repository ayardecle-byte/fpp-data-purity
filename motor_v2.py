...
CALIDAD_LIGAS = {
    # ============================================================
    # Validacion de agosto 2026 · 41.372 predicciones · test 20.686
    # ============================================================

    # ===== ALTA: ventaja confirmada (skill > 0.010) =====
    "estonia":        {"nivel": "ALTA",  "skill": 0.0256, "n_test": 246},
    "czechrepublic":  {"nivel": "ALTA",  "skill": 0.0250, "n_test": 370},
    "portugal":       {"nivel": "ALTA",  "skill": 0.0246, "n_test": 435},
    "netherlands":    {"nivel": "ALTA",  "skill": 0.0204, "n_test": 435},
    "russia":         {"nivel": "ALTA",  "skill": 0.0200, "n_test": 207},
    "turkey":         {"nivel": "ALTA",  "skill": 0.0193, "n_test": 472},
    "italy":          {"nivel": "ALTA",  "skill": 0.0180, "n_test": 1049},
    "ukraine":        {"nivel": "ALTA",  "skill": 0.0178, "n_test": 356},
    "china":          {"nivel": "ALTA",  "skill": 0.0176, "n_test": 581},
    "serbia":         {"nivel": "ALTA",  "skill": 0.0153, "n_test": 254},
    "mexico":         {"nivel": "ALTA",  "skill": 0.0145, "n_test": 161},
    "germany":        {"nivel": "ALTA",  "skill": 0.0137, "n_test": 416},
    "champions":      {"nivel": "ALTA",  "skill": 0.0136, "n_test": 946},
    "spain":          {"nivel": "ALTA",  "skill": 0.0123, "n_test": 1200},
    "norway":         {"nivel": "ALTA",  "skill": 0.0117, "n_test": 906},
    "finland":        {"nivel": "ALTA",  "skill": 0.0115, "n_test": 449},

    # ===== MEDIA: ventaja moderada (0.003 - 0.010) =====
    "netherlands2":   {"nivel": "MEDIA", "skill": 0.0095, "n_test": 511},
    "scotland":       {"nivel": "MEDIA", "skill": 0.0094, "n_test": 385},
    "europa":         {"nivel": "MEDIA", "skill": 0.0093, "n_test": 439},
    "sweden":         {"nivel": "MEDIA", "skill": 0.0092, "n_test": 496},
    "bolivia":        {"nivel": "MEDIA", "skill": 0.0078, "n_test": 251},
    "iceland":        {"nivel": "MEDIA", "skill": 0.0078, "n_test": 356},
    "france":         {"nivel": "MEDIA", "skill": 0.0074, "n_test": 462},
    "england":        {"nivel": "MEDIA", "skill": 0.0071, "n_test": 571},
    "germany2":       {"nivel": "MEDIA", "skill": 0.0070, "n_test": 420},
    "portugal2":      {"nivel": "MEDIA", "skill": 0.0050, "n_test": 417},
    "mls":            {"nivel": "MEDIA", "skill": 0.0046, "n_test": 1017},
    "france2":        {"nivel": "MEDIA", "skill": 0.0042, "n_test": 444},
    "spain2":         {"nivel": "MEDIA", "skill": 0.0039, "n_test": 630},
    "japan":          {"nivel": "MEDIA", "skill": 0.0038, "n_test": 756},
    "poland":         {"nivel": "MEDIA", "skill": 0.0035, "n_test": 434},

    # ===== BAJA: ventaja marginal (0 - 0.003) =====
    "switzerland":    {"nivel": "BAJA",  "skill": 0.0028, "n_test": 333},
    "england3":       {"nivel": "BAJA",  "skill": 0.0027, "n_test": 170},
    "brazil":         {"nivel": "BAJA",  "skill": 0.0026, "n_test": 1054},
    "argentina":      {"nivel": "BAJA",  "skill": 0.0023, "n_test": 1492},
    "croatia":        {"nivel": "BAJA",  "skill": 0.0012, "n_test": 134},
    "southkorea":     {"nivel": "BAJA",  "skill": 0.0012, "n_test": 229},

    # ===== NULA: sin ventaja demostrable =====
    "italy2":         {"nivel": "NULA",  "skill": -0.0001, "n_test": 278},
    "serie_b_brasil": {"nivel": "NULA",  "skill": -0.0002, "n_test": 209},
    "england2":       {"nivel": "NULA",  "skill": -0.0042, "n_test": 176},
    ...
    "romania":          {"nivel": "SIN_VALIDAR", "skill": 0.0, "n_test": 0},
